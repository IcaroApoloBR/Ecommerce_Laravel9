                    ...
                    <div class="flex flex-wrap">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input value="{{ old('name', $product->name) }}" type="text" id="name"
                                    name="name"
                        ...
                        <div class="p-2 w-full">
                            <div class="relative">
                                ...
                                <textarea id="description" name="description"
                                    class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-rose-500 focus:bg-white focus:ring-2 focus:ring-rose-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ old('description', $product->description) }}</textarea>
                            </div>
                            @error('description')
                                <div class="text-red-400 text-sm">{{ $message }}</div>
                            @enderror
