    ...
    <footer class="text-gray-600">
            ...
            <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
                <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
                    <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
                        <label for="footer-field" class="leading-7 text-sm text-gray-600">Informe seu e-mail</label>
                    ...
                    <button
                        class="inline-flex text-white bg-rose-500 border-0 py-2 px-6 focus:outline-none hover:bg-rose-600 rounded">Enviar</button>
                    <p class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">Deseja receber notificações
                        <br class="lg:block hidden">sobre seus produtos favoritos ?
                    </p>
                </div>
        ...
        <div class="bg-gray-100">
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                <p class="text-gray-500 text-sm text-center sm:text-left">© 2022 Laravel com Tailwind — GitHub
                    <a href="https://github.com/IcaroApoloBR/Ecommerce_Laravel9" class="text-gray-600 ml-1" target="_blank"
                        rel="noopener noreferrer">@IcaroApoloBR</a>
                </p>
                <span
                    class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-500 text-sm">Curso Laravel 9 com o professor Tiago Matos</span>
            </div>
        </div>
    </footer>
</body>
